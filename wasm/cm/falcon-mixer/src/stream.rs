// Falcon Quad Mixer — P3 Stream Transformer (shared cascade-stream types).
//
// stream<torque-setpoint> -> stream<motor-pwm> over the shared types
// (STREAM-P10). Drives the verified relay-mix-quad QuadMixer.
